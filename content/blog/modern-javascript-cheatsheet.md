...
- [Modern JavaScript Cheatsheet](#modern-javascript-cheatsheet)
  ...
  - [Notions](#notions)
    ...
    - [<a name="arrow_func_concept"></a> Arrow function](#a-name%22arrowfuncconcept%22a-arrow-function)
    ...
    - [Array methods - map / filter / reduce](#array-methods---map--filter--reduce)
      ...
      - [Explanation](#explanation)
        ...
        - [Array.prototype.reduce()](#arrayprototypereduce)
          - [At first iteration step](#at-first-iteration-step)
          - [At second iteration step](#at-second-iteration-step)
          - [At third iteration step](#at-third-iteration-step)
          - [At fourth iteration step](#at-fourth-iteration-step)
          - [[...] At last iteration step](#at-last-iteration-step)
      - [External Resource](#external-resource)
    - [Spread operator "..."](#spread-operator-%22%22)
    ...
    - [<a name="this_def"></a> JavaScript *this*](#a-name%22thisdef%22a-javascript-this)
  ...
  - [Glossary](#glossary)
    - [<a name="scope_def"></a> Scope](#a-name%22scopedef%22a-scope)
    - [<a name="mutation_def"></a> Variable mutation](#a-name%22mutationdef%22a-variable-mutation)
...
Source : [modern-js-cheatsheet](https://github.com/mbeaudru/modern-js-cheatsheet)